...
// Region to deploy ephemeral test resources into. sa-east-1 matches the repo's existing
// installation_test convention (a less-used region, avoids account limits).
