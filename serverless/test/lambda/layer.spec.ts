...
describe("findLambdas", () => {
  it("finds lambdas and correctly assigns runtime types", () => {
    const resources = {
      ...
      Python316Function: mockFunctionResource("python3.16", ["x86_64"]),
    ...
    expect(lambdas).toEqual([
      ...
      mockLambdaFunction("Python316Function", "python3.16", RuntimeType.PYTHON, "x86_64", ArchitectureType.x86_64),
