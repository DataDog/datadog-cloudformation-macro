...
describe("findLambdas", () => {
  it("finds lambdas and correctly assigns runtime types", () => {
    const resources = {
      ...
      Python315Function: mockFunctionResource("python3.15", ["x86_64"]),
    ...
    expect(lambdas).toEqual([
      ...
      mockLambdaFunction("Python315Function", "python3.15", RuntimeType.PYTHON, "x86_64", ArchitectureType.x86_64),
