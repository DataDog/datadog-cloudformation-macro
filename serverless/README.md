...
| `site`                      | Set which Datadog site to send data, only needed when `flushMetricsToLogs` is `false`. Possible values are `datadoghq.com`, `datadoghq.eu`, `us3.datadoghq.com`, `us5.datadoghq.com`, `ap1.datadoghq.com`, `ap2.datadoghq.com`, `ddog-gov.com`, and `test123.prod.dog`. The default is `datadoghq.com`.                                                                                                                                                                                                                                                                             |
...
| `apiKeySsmArn`              | The ARN of the parameter storing the Datadog API key in AWS Systems Manager Parameter Store. Use this parameter in place of `apiKey` when `flushMetricsToLogs` is `false` or `extensionLayerVersion` is set. Remember to add the `ssm:GetParameter` permission to the Lambda execution role.                                                                                                                                                                                                                                              |
