...
| `service`               | When set along with a `forwarderArn`, the macro adds an `service` tag to all Lambda functions with the provided value. When set along with the `extensionLayerVersion`, the macro adds a `DD_SERVICE` environment variable is added to all lambda functions with the provided value.                                                                                                                                                                                                                |
| `env`                   | When set along with a `forwarderArn`, the macro adds an `env` tag to all Lambda functions with the provided value. When set along with the `extensionLayerVersion`, the macro adds a `DD_ENV` environment variable is added to all lambda functions with the provided value.                                                                                                                                                                                                                        |
| `version`               | When set along with a `forwarderArn`, the macro adds `version` tag to all Lambda functions with the provided value. When set along with the `extensionLayerVersion`, the macro adds a `DD_VERSION` environment variable is added to all lambda functions with the provided value.                                                                                                                                                                                                                   |
| `tags`                  | A comma separated list of key:value pairs as a single string. When set along with `forwarderArn`, the macro parses the string and sets each key:value pair as a tag to all Lambda functions. When set along with `extensionLayerVersion`, a `DD_TAGS` environment variable is added to all Lambda functions with the provided value.                                                                                                                                                                |
