...
| `extensionLayerVersion` | Version of the Datadog Lambda Extension layer to install, such as 5. When `extensionLayerVersion` is set, `apiKey` (or `apiKMSKey`) needs to be set as well. While using `extensionLayerVersion` do not set `forwarderArn`. Learn more about the Lambda extension [here][8].                                                                                                                                                                                                                        |
...
| `captureLambdaPayload`  | Automatically tags a function request and response so it is displayed in the APM application.                                                                                                                                                                                                                                                                                                                                                                                                       |
